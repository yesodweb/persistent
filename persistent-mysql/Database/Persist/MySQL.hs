...
instance MySQL.Param P where
    ...
    render (P (PersistLocalTime t))   = MySQL.render $ show t
...
parseType "datetime"   = return SqlDayTimeUTC
parseType "timestamp"  = return SqlDayTimeUTC
...
showSqlType SqlDayTimeLocal _     = "DATETIME"
showSqlType SqlDayTimeUTC _       = "VARCHAR(50) CHARACTER SET utf8"
